...
mat.set_density('sum')
mat.add_nuclide('Pu239', 6.5822e-05)
mat.add_nuclide('Pu240', 2.1109e-06)
mat.add_nuclide('N14', 2.0590e-03)
mat.add_nuclide('H1', 6.1880e-02)
mat.add_nuclide('O16', 3.6223e-02)
mat.add_element('Fe', 1.0352e-06)
