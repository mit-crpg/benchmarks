...
mat.name = "HEU"
mat.set_density('sum')
mat.add_nuclide('U234', 4.9483e-04)
mat.add_nuclide('U235', 4.4918e-02)
mat.add_nuclide('U236', 1.5917e-04)
mat.add_nuclide('U238', 2.5740e-03)
mats.append(mat)

mat = openmc.Material(2)
mat.name = "c_Graphite"
mat.set_density('sum')
mat.add_element('C', 8.5380e-02)
