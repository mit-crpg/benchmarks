...
mat.name = "HEU"
mat.set_density('sum')
mat.add_nuclide('U234', 4.9576e-04)
mat.add_nuclide('U235', 4.4941e-02)
mat.add_nuclide('U236', 1.5931e-04)
mat.add_nuclide('U238', 2.5799e-03)
mats.append(mat)

mat = openmc.Material(2)
mat.name = "c_Graphite"
mat.set_density('sum')
mat.add_element('C', 8.5821e-02)
