...
mat.name = "Plutonium nitrate solution (17.7 g/L)"
mat.set_density('sum')
mat.add_nuclide('Pu239', 3.31381e-05)
mat.add_nuclide('Pu240', 8.39670e-06)
mat.add_nuclide('Pu241', 2.48905e-06)
mat.add_nuclide('Pu242', 5.02795e-07)
mat.add_nuclide('Am241', 2.69732e-07)
mat.add_element('N', 1.38481e-03)
mat.add_element('O', 3.53758e-02)
mat.add_nuclide('H1', 6.36291e-02)
mat.add_element('Fe', 4.42112e-06)
mat.add_element('Cr', 1.42172e-06)
mat.add_element('Ni', 1.00765e-06)
