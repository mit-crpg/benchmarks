...
mat.set_density('sum')
mat.add_nuclide('Pu239', 1.3689e-04)
mat.add_nuclide('Pu240', 4.3902e-06)
mat.add_nuclide('N14', 2.0104e-03)
mat.add_nuclide('H1', 6.1779e-02)
mat.add_nuclide('O16', 3.6198e-02)
mat.add_element('Fe', 2.6419e-06)
mats.append(mat)
