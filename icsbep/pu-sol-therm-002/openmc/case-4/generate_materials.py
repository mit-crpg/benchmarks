...
mat.set_density('sum')
mat.add_nuclide('Pu239', 1.4556e-04)
mat.add_nuclide('Pu240', 4.6680e-06)
mat.add_nuclide('N14', 2.3018e-03)
mat.add_nuclide('H1', 6.1211e-02)
mat.add_nuclide('O16', 3.6660e-02)
mat.add_element('Fe', 2.0704e-06)
