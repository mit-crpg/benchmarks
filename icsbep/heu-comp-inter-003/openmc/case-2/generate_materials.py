...
mat = openmc.Material(15)
mat.name = "HEU, Can A"
mat.set_density('sum')
mat.add_nuclide('U234', 2.4557e-04)
mat.add_nuclide('U235', 2.3030e-02)
mat.add_nuclide('U236', 1.0085e-04)
mat.add_nuclide('U238', 1.3124e-03)
mat.add_element('H', 7.0290e-02)
mat.add_element('O', 6.0031e-04)
mat.add_element('C', 9.6792e-05)
mat.add_element('N', 2.6305e-04)
mat.add_element('Fe', 8.9855e-05)
mat.add_element('Au', 3.2844e-04)
mats.append(mat)

mat = openmc.Material(16)
mat.name = "HEU, Can B"
mat.set_density('sum')
mat.add_nuclide('U234', 2.5226e-04)
mat.add_nuclide('U235', 2.2951e-02)
mat.add_nuclide('U236', 1.0055e-04)
mat.add_nuclide('U238', 1.3058e-03)
mat.add_element('H', 7.3240e-02)
mat.add_element('O', 4.9360e-04)
mat.add_element('C', 1.2804e-04)
mat.add_element('N', 2.3019e-04)
mat.add_element('Fe', 6.7706e-05)
mat.add_element('Au', 3.0140e-04)
mats.append(mat)
