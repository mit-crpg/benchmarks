...
mat.set_density('sum')
mat.add_nuclide('Pu239', 8.1071e-05)
mat.add_nuclide('Pu240', 3.4077e-06)
mat.add_nuclide('N14', 2.0464e-03)
mat.add_nuclide('H1', 6.2039e-02)
mat.add_nuclide('O16', 3.6305e-02)
mat.add_element('Fe', 1.0460e-06)
