...
mat.set_density('sum')
mat.add_nuclide('Pu239', 7.5970e-05)
mat.add_nuclide('Pu240', 3.1933e-06)
mat.add_nuclide('N14', 1.4258e-03)
mat.add_nuclide('H1', 6.3387e-02)
mat.add_nuclide('O16', 3.5416e-02)
mat.add_element('Fe', 9.2736e-07)
