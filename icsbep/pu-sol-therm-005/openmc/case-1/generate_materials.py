...
mat.set_density('sum')
mat.add_nuclide('Pu239', 7.1668e-05)
mat.add_nuclide('Pu240', 3.0124e-06)
mat.add_nuclide('N14', 8.4973e-04)
mat.add_nuclide('H1', 6.4700e-02)
mat.add_nuclide('O16', 3.4624e-02)
mat.add_element('Fe', 1.3802e-06)
