...
mat.set_density('sum')
mat.add_nuclide('Pu239', 7.3819e-05)
mat.add_nuclide('Pu240', 3.1029e-06)
mat.add_nuclide('N14', 1.1587e-03)
mat.add_nuclide('H1', 6.4054e-02)
mat.add_nuclide('O16', 3.5077e-02)
mat.add_element('Fe', 8.5187e-07)
