...
mat.set_density('sum')
mat.add_nuclide('U234', 6.3833e-07)
mat.add_nuclide('U235', 7.9213e-05)
mat.add_nuclide('U236', 7.9114e-08)
mat.add_nuclide('U238', 7.0556e-04)
mat.add_nuclide('H1', 5.6956e-02)
mat.add_nuclide('N14', 2.8778e-03)
mat.add_element('O', 3.8029e-02)
