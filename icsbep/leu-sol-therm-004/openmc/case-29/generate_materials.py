...
mat.set_density('sum')
mat.add_nuclide('U234', 5.9778e-07)
mat.add_nuclide('U235', 7.4181e-05)
mat.add_nuclide('U236', 7.4088e-08)
mat.add_nuclide('U238', 6.6074e-04)
mat.add_nuclide('H1', 5.7216e-02)
mat.add_nuclide('N14', 2.8141e-03)
mat.add_element('O', 3.7850e-02)
