...
mat.set_density('sum')
mat.add_nuclide('U234', 4.8004e-07)
mat.add_nuclide('U235', 5.9569e-05)
mat.add_nuclide('U236', 5.9495e-08)
mat.add_nuclide('U238', 5.3059e-04)
mat.add_nuclide('H1', 5.8528e-02)
mat.add_nuclide('N14', 2.5544e-03)
mat.add_element('O', 3.7422e-02)
