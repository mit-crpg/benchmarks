...
mat.set_density('sum')
mat.add_nuclide('Pu239', 6.5921e-05)
mat.add_nuclide('Pu240', 3.5641e-07)
mat.add_nuclide('N14', 1.0392e-03)
mat.add_nuclide('H1', 6.4397e-02)
mat.add_nuclide('O16', 3.4929e-02)
mat.add_element('Fe', 1.6067e-06)
