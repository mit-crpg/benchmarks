...
mat.set_density('sum')
mat.add_nuclide('U234', 7.6555e-07)
mat.add_nuclide('U235', 9.4999e-05)
mat.add_nuclide('U236', 9.4881e-08)
mat.add_nuclide('U238', 8.4617e-04)
mat.add_nuclide('H1', 5.7800e-02)
mat.add_nuclide('N14', 2.3658e-03)
mat.add_element('O', 3.7641e-02)
