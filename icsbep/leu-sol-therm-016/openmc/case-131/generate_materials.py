...
mat.set_density('sum')
mat.add_nuclide('U234', 6.7703e-07)
mat.add_nuclide('U235', 8.4015e-05)
mat.add_nuclide('U236', 8.3910e-08)
mat.add_nuclide('U238', 7.4833e-04)
mat.add_nuclide('H1', 5.8738e-02)
mat.add_nuclide('N14', 2.1480e-03)
mat.add_element('O', 3.7238e-02)
