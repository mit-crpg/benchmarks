...
mat.set_density('sum')
mat.add_nuclide('U234', 9.5555e-07)
mat.add_nuclide('U235', 1.1858e-04)
mat.add_nuclide('U236', 1.1843e-07)
mat.add_nuclide('U238', 1.0562e-03)
mat.add_nuclide('H1', 5.5582e-02)
mat.add_nuclide('N14', 2.8697e-03)
mat.add_element('O', 3.8481e-02)
