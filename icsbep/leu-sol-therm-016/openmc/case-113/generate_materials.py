...
mat.set_density('sum')
mat.add_nuclide('U234', 8.8494e-07)
mat.add_nuclide('U235', 1.0981e-04)
mat.add_nuclide('U236', 1.0968e-07)
mat.add_nuclide('U238', 9.7813e-04)
mat.add_nuclide('H1', 5.6459e-02)
mat.add_nuclide('N14', 2.6597e-03)
mat.add_element('O', 3.8146e-02)
