...
mat.set_density('sum')
mat.add_nuclide('U234', 1.3369e-06)
mat.add_nuclide('U235', 1.2657e-04)
mat.add_nuclide('U236', 6.7629e-07)
mat.add_nuclide('U238', 7.1620e-06)
mat.add_nuclide('F19', 2.7149e-04)
mat.add_element('O', 3.3396e-02)
mat.add_nuclide('H1', 6.6248e-02)
