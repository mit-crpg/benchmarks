...
mat.set_density('sum')
mat.add_nuclide('Pu239', 8.9837e-05)
mat.add_nuclide('Pu240', 2.8811e-06)
mat.add_nuclide('N14', 1.2140e-03)
mat.add_nuclide('H1', 6.4172e-02)
mat.add_nuclide('O16', 3.5307e-02)
mat.add_element('Fe', 1.3803e-06)
