...
mat.set_density('sum')
mat.add_nuclide('Pu239', 8.4936e-05)
mat.add_nuclide('Pu240', 1.5153e-06)
mat.add_nuclide('N14', 1.1315e-03)
mat.add_nuclide('H1', 6.4208e-02)
mat.add_nuclide('O16', 3.5106e-02)
mat.add_element('Fe', 1.2616e-06)
